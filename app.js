...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // When the pet owner button is clicked
  ownerBtn.addEventListener('click', function () {
    // Generate a unique code for the pet owner
    const groupCode = generateGroupCode();
    
    // Save the group code and role in localStorage
...
function generateGroupCode() {
  ...
  return code;
    ...
    window.location.href = "pet-profile.html"; // Redirect to the pet profile page
  });

  // When the caregiver button is clicked
